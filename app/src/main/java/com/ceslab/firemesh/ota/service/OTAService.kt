package com.ceslab.firemesh.ota.service
...
import com.ceslab.firemesh.ota.ble.*
import com.ceslab.firemesh.ota.callbacks.BLEScanCallbackLollipop
import com.ceslab.firemesh.ota.callbacks.BScanCallback
...
class OTAService : LocalService<OTAService>() {
    companion object {
        ...
        private val TAG = OTAService::class.java.simpleName
        private const val RSSI_UPDATE_FREQ: Long = 2000
    }

    abstract class Binding(context: Context) : LocalService.Binding<OTAService>(context) {

        override fun getServiceClass(): Class<OTAService> {
            return OTAService::class.java
        }
    }
    ...
    class Receiver : BroadcastReceiver() {
        ...
        companion object {
            ...
            val registeredServices: MutableList<OTAService> = ArrayList()
        }
    }
    ...
    private fun startDiscovery() {
        ...
        handler.removeCallbacks(scanTimeout)
        if (useBLE) {
            val scannerCallback: ScanCallback =
                BLEScanCallbackLollipop(
                    this
                )
    ...
    private fun scanDiscoveredDevices(): Boolean {
        ...
        synchronized(discoveredDevices) {
            ...
            devInfoForDiscovery.discover(object : BluetoothLEGatt(this@OTAService, devInfoForDiscovery.device) {
