...
enum class BleFormat(val nameResId: Int, val iconResId: Int) {
    UNSPECIFIED(0, R.drawable.ic_launcher_background),
    I_BEACON(1,R.drawable.ic_launcher_background),
    ALT_BEACON(2,R.drawable.ic_launcher_background),
    EDDYSTONE(3, R.drawable.ic_launcher_background);
