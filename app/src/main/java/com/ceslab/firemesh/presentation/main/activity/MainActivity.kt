    ...
    fun testData() {
        ...
        try {
            val encryptTest = byteArrayOf(
                ...
                0xea.toByte(), 0x3c,
                0xef.toByte(),
                0x8a.toByte(), 0x2c, 0x3b,
                0x88.toByte(), 0x4c,
                0xfa.toByte(), 0x59, 0x66,
                0xe9.toByte(), 0x4b,
                0xd4.toByte(),
                0xbe.toByte(),
                0xd0.toByte(), 0x65, 0x43,
                0xe6.toByte(), 0x08, 0x4d, 0x10,
                0x15,
                0xc4.toByte(), 0x46, 0x01,
                0xd1.toByte(), 0x42, 0x25,
                0xd1.toByte(), 0x31,
                0xff.toByte(), 0x7e, 0x92.toByte(), 0x75,
                0x9d.toByte(), 0x92.toByte(), 0x30, 0x87.toByte(), 0xf5.toByte(),
                0x9a.toByte(), 0xf4.toByte(),
                0x01, 0xcd.toByte(), 0xea.toByte(), 0x3c
            )

            val encryptedData =
                AESUtils.encrypt(AESUtils.ECB_ZERO_BYTE_PADDING_ALGORITHM, aesKey, rawData)
            Timber.d("Test:encryptedData= " + Converters.bytesToHexWhitespaceDelimited(encryptedData) + "--size = ${encryptedData.size}")
            val decriptedData =
                AESUtils.decrypt(AESUtils.ECB_ZERO_BYTE_PADDING_ALGORITHM, aesKey, encryptedData)
            Timber.d("Test:decriptedData= " + Converters.bytesToHexWhitespaceDelimited(decriptedData) + "--size = ${decriptedData.size}")
